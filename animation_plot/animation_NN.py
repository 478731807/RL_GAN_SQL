...
def init():
    fpath = "C:/Users/USER/PycharmProjects/RL/animation_images/0.jpg";
    img = Image.open(fpath);
    plt.axis('off') # 关掉坐标轴为 off
    return plt.imshow(img);

def update(i):
    fpath = "C:/Users/USER/PycharmProjects/RL/animation_images/" + str(i) + ".jpg";
    img = Image.open(fpath);
    plt.axis('off') # 关掉坐标轴为 off
    return plt.imshow(img);
...
#     x_sample = sample(low,up,20);
    ...
    for i in range(100):
        filepath="C:/Users/USER/PycharmProjects/RL/animation_plot/weights-improvement-" + str(i + 1) + ".hdf5";
        ...
        ffpath = "C:/Users/USER/PycharmProjects/RL/animation_images/" + str(i) + ".jpg";
        plt.savefig(ffpath);

        plt.pause(0.01)             # 暂停0.01秒

    ani = animation.FuncAnimation(plt.figure(2), update,range(100),init_func=init, interval=500)
    ani.save("C:/Users/USER/PycharmProjects/RL//test.gif",writer='pillow')
